...
/usr/bin/docker run --expose=8080 --publish=8080:8080 --restart="always" -v $SCRIPT_FOLDER:$APPLICATION_DESTINATION_FOLDER_NAME java java -jar $APPLICATION_DESTINATION_FOLDER_NAME/application-1.0-SNAPSHOT.jar